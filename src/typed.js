...
$(function() {
    $("#typed").typed({
        ...
        loopCount: !1,
        callback: function() {
            console.log(typed.backspace), newTyped()
        },
        ...
        typewrite: function(t, s) {
            if (this.stop !== !0) {
                var e = Math.round(70 * Math.random()) + this.typeSpeed,
                    o = this;
                2 == o.arrayPos ? (o.backDelay = 2e3, o.backSpeed = 500) : o.backDelay = 0, o.timeout = setTimeout(function() {
                    var e = 0,
                        r = t.substr(s);
                    if ("^" === r.charAt(0)) {
                        var i = 1;
        ...
        backspace: function(t, s) {
            if (this.stop !== !0) {
                var e = Math.round(70 * Math.random()) + this.backSpeed,
                    o = this;
                o.timeout = setTimeout(function() {
                    if (0 == o.arrayPos ? o.stopNum = 29 : 1 == o.arrayPos ? o.stopNum = 30 : (console.log(o.arrayPos), o.stopNum = 24), "html" === o.contentType && ">" === t.substr(s).charAt(0)) {
                        for (var e = "";
